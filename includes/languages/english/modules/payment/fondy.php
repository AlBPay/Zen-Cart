...
define( 'MODULE_PAYMENT_FONDY_TEXT_ADMIN_TITLE', 'Alliance bank' );
define( 'MODULE_PAYMENT_FONDY_TEXT_CATALOG_TITLE', 'Alliance bank' );

if( IS_ADMIN_FLAG === true )
    define( 'MODULE_PAYMENT_FONDY_TEXT_DESCRIPTION',
        '<strong>Alliance bank</strong><br />'.
        '<a href="https://portal.albpay.io/mportal/" target="_blank">'.
        'Manage your Alliance bank account.</a><br /><br />'.
        '<font color="green">Configuration Instructions:</font><br />'.
        '<ol style="padding-left: 20px;">'.
        '<li><a href="https://portal.albpay.io/mportal/#/account/registration" target="_blank">Register for a Alliance bank account.</a></li>'.
        '<li>Click "install" above to enable Alliance bank support and "edit" to tell Zen Cart your Alliance bank settings</li>'.
        '</ol>'.
        '*<strong>PHP allow_url_fopen</strong> must be enabled<br />'.
        '*<strong>Settings</strong> must be configured as described above.' );
else
    define( 'MODULE_PAYMENT_FONDY_TEXT_DESCRIPTION', '<strong>Alliance bank</strong>');

define( 'MODULE_PAYMENT_FONDY_BUTTON_IMG', DIR_WS_IMAGES .'fondy/logo_small.png' );
define( 'MODULE_PAYMENT_FONDY_BUTTON_ALT', 'Checkout with Alliance bank' );
define( 'MODULE_PAYMENT_FONDY_ACCEPTANCE_MARK_TEXT', '' );

define( 'MODULE_PAYMENT_FONDY_TEXT_CATALOG_LOGO',
    '<a href="https://example.com" style="border: 0;" target="_blank">'.
