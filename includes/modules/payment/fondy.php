...
class fondy extends base
{
    ...
    function install()
    {
        ...
        $db->Execute(
            ...
            VALUES( 'Merchant ID', 'MODULE_PAYMENT_FONDY_MERCHANT_ID', '1545859', 'Your Merchant ID from Fondy<br><span style=\"font-size: 0.9em; color: green;\">(Click <a href=\"https://portal.albpay.io/mportal/#/merchant/list\" target=\"_blank\">here</a> to get yours.)</span>', '6', '0', now() )" );
        // MODULE_PAYMENT_FONDY_MERCHANT_KEY (Default = Generic sandbox credentials)
        $db->Execute(
            "INSERT INTO ". TABLE_CONFIGURATION ."( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added )
            VALUES( 'Merchant Key', 'MODULE_PAYMENT_FONDY_MERCHANT_KEY', 'test', 'Your Merchant Secret Key from Fondy<br><span style=\"font-size: 0.9em; color: green;\">(Click <a href=\"https://portal.albpay.io/mportal/#/merchant/list\" target=\"_blank\">here</a> to get yours.)</span>', '6', '0', now() )" );
        // MODULE_PAYMENT_FONDY_TEST (Default = Test)
        $db->Execute(
            "INSERT INTO ". TABLE_CONFIGURATION ."( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added )
            VALUES( 'Transaction TEST', 'MODULE_PAYMENT_FONDY_TEST', 'Test', 'Select the Alliance bank test mode', '6', '0', 'zen_cfg_select_option(array(\'Live\', \'Test\'), ', now() )" );
        ...
        $db->Execute(
            ...
            VALUES( 'Set Preparing Order Status', 'MODULE_PAYMENT_FONDY_PREPARE_ORDER_STATUS_ID', '1', 'Set the status of prepared orders made with Alliance bank to this value', '6', '0', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
        // MODULE_PAYMENT_FONDY_ORDER_STATUS_ID
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . "( configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added )
            VALUES( 'Set Acknowledged Order Status', 'MODULE_PAYMENT_FONDY_ORDER_STATUS_ID', '2', 'Set the status of orders made with Alliance bank to this value', '6', '0', 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now())");
