 ...
 * fondy_functions.php
 *
 * Functions used by payment module class for Alliance bank ITN payment method
 *
 */

// Posting URLs
define( 'MODULE_PAYMENT_FONDY_URL_LIVE', 'payment.albpay.io/api/checkout/redirect/' );
define( 'MODULE_PAYMENT_FONDY_URL_TEST', 'payment.albpay.io/api/checkout/redirect/' );
...
function f_updateOrderStatusAndHistory( $fData, $zcOrderId, $newStatus = 1, $txnType, $ts ) {
	...
	$sqlArray = array(
		...
		'customer_notified' => '0',
		'comments'          => 'Alliance bank status: ' . $fData['order_status'],
	);
