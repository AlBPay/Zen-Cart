...
define( 'TEXT_SORT_FONDY_ID_DESC', 'Alliance bank Order Received (new - old)' );
define( 'TEXT_SORT_FONDY_ID', 'Alliance bank Order Received (old - new)' );
define( 'TEXT_SORT_ZEN_ORDER_ID_DESC', 'Order ID (high - low), Alliance bank Order Received' );
define( 'TEXT_SORT_ZEN_ORDER_ID', 'Order ID (low - high), Alliance bank Order Received' );
define( 'TEXT_PAYMENT_AMOUNT_DESC', 'Order Amount (high - low)' );
define( 'TEXT_PAYMENT_AMOUNT', 'Order Amount (low - high)' );

// Page headings
define( 'HEADING_ADMIN_TITLE', 'Alliance bank' );
define( 'HEADING_PAYMENT_STATUS', 'Payment Status' );

// Table headings
define( 'TABLE_HEADING_ORDER_NUMBER', 'Order #' );
define( 'TABLE_HEADING_MERCHANT_REF', 'Merchant ref on Alliance bank' );
...
// Right pane headings
define( 'TEXT_INFO_Alliance bank_HEADING', 'Alliance bank' );
